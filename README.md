...
备注:这个项目是我在学习完菜鸟窝[点击跳转](www.cniao5.com)研发的android课程后,结合自己在工作中遇到的技术知识点进行开发的,一方面加强自己的开发过程中的薄弱环节,另一方面帮助更多的初级Android工程师进阶.菜鸟窝作为程序员的黄埔军校,相信很多从事android开发的人员都知道,甚至很多人的入门老师就是她.如果您还没听过菜鸟窝,赶紧点击上面链接去看看吧.
